...
import routerTheater from './routes/theaters.js'
import routerManagers from './routes/managers.js'
import routerPendings from './routes/pendings.js'
...
app.use('/theaters', routerTheater)
app.use('/managers', routerManagers)
app.use('/pendings', routerPendings)
